...
{
    /**
     * Path to the concrete version of the CaaS API
     */
    public const API_URL_PATH = 'api/v2/';
    ...
    public function execute(
        ...
        try {
            ...
            $this->treviPayLogger->debug('Performing a call to the MSTS API', $debugData);
            ...
            if ($response) {
                ...
                $this->treviPayLogger->debug('Error during performing a call to the MSTS API', $debugData);
